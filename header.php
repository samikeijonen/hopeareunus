...
<body class="<?php hybrid_body_class(); ?>">
	...
	<div id="container">
			...
			<?php if ( get_theme_mod( 'logo_upload') ) { // Use logo if is set. Else use bloginfo name. ?>	
					<h1 id="site-title">
						<a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>">
							<img class="hopeareunus-logo" src="<?php echo esc_url( get_theme_mod( 'logo_upload' ) ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" />
						</a>
					</h1>
			<?php } else { ?>
		...
		<div id="main">
			...
			<?php if ( current_theme_supports( 'breadcrumb-trail' ) ) breadcrumb_trail( array( 'container' => 'nav', 'labels' => array( 'browse' => __( 'You are here:', 'hopeareunus' ) ), 'separator'  => __( '&#8764;', 'hopeareunus' ), 'show_on_front' => false ) ); ?>